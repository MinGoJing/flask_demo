...
class RET(object):
    ...
    E_ORM_EXT_JOIN_RULE_CONST_VALUE_FORMAT_ERROR = \
    ...
    E_ENTITY_BACKREF_NOT_FOUND_ERROR = \
        (FAIL_CODE(PLF_LAYER, MODULE_ORM, 0x500, 0x05))
    E_ENTITY_EXT_JOIN_RULE_CONFIG_ERROR = \
        (FAIL_CODE(PLF_LAYER, MODULE_ORM, 0x500, 0x06))
    ...
    _info_dict = {
        ...
        E_ENTITY_EXT_JOIN_RULE_CONFIG_ERROR: {
            "en": "E_ENTITY_EXT_JOIN_RULE_CONFIG_ERROR",
            "zh-cn": "ORM 数据表自定义Join配置有误"},
        E_ENTITY_UPDATE_UNIQUE_ERROR: {
