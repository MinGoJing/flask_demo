...
@License :   Copyright © since 2020 MinGo All Rights Reserved.ll Rights Reserved.
@History :   
    1.0: 2020/05/20 05:35, MinGo
          1. Created.
...
class RET(object):
    ...
    ##=========================================================##
    E_ = \
        (FAIL_CODE(API_LAYER, MODULE_MSS, 0x500, 0x01))
