...
task_output_add_par.add_argument('module_name',
                                 type=str,
                                 help='module_name.')
task_output_add_par.add_argument('key',
                                 type=str, required=True,
                                 help='key. (Required)')
task_output_add_par.add_argument('index',
                                 type=int, required=True,
                                 help='index. (Required)')
task_output_add_par.add_argument('data_type',
                                 type=int, required=True,
                                 help='data_type. (Required)')
task_output_add_par.add_argument('value',
                                 type=str,
                                 help='value.')
...
task_output_put_par.add_argument('value',
                                 ...
                                 help='value.')
# get
task_output_get_par = RequestParser()

# delete & disable
task_output_dd_par = CommonDisableParser()  # id, ids, desc
